...
\begin{timeitemize}[Postdoctoral Fellow, Atlanta, GA]{Georgia Tech}{Feb. 2025 -- Present}
    \item As a finalist of DARPA AIxCC, designed and implemented LLM-powered exploit generation and fuzzing agents, significantly improving team productivity and analysis throughput through robust automation and tooling.
...
\begin{timeitemize}[Senior Engineer, South Korea]{Samsung Security Center, Samsung SDS}{Aug. 2022 -- Dec. 2024}
    ...
    Additionally, I expanded the traditional Red Team perspective to address AI safety issues and implemented an automated AI safety checker leveraging safety guardrail frameworks.
...
\begin{timeitemize}[Research Intern, South Korea]{Pinion Industries}{Dec. 2013 -- Feb. 2014}
    \item At this automotive software and security startup, I analyzed and exploited in-vehicle components (network systems, AVN, telematics, smart keys, ECUs), achieving remote code execution on AVN systems and investigating smart key cloning for potential theft and eavesdropping scenarios.
