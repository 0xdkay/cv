...
I am a security engineer and researcher specializing in uncovering novel,
cross-domain security threats across AI, IoT, cellular networks, and cyber-physical systems.
I have a proven track record of identifying and developing practical security solutions at scale,
from AI-based automated vulnerability discovery to securing enterprise-level AI infrastructures.
As a DARPA AIxCC finalist, I demonstrated expertise in
building LLM-powered exploit generation agents and advancing autonomous security analysis.
At Samsung SDS, I drove Red Team operations to proactively mitigate threats against global products and services.
Recognized through 5x DEFCON finals, 9 top-tier publications (USENIX Security, CCS, NDSS, TSE, TMC),
7 patents, and 17+ industry/government projects.
Passionate about bridging cutting-edge research with real-world impact to secure large-scale systems and services.
...
\begin{timeitemize}[Postdoctoral Fellow, Atlanta, GA]{Georgia Tech}{Feb. 2025 -- Present}
    \item Led design and implementation of LLM-powered exploit generation and fuzzing agents, significantly improving team productivity and analysis throughput through robust automation and tooling.
