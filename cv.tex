...
\begin{timeitemize}[Senior Engineer, South Korea]{Samsung Security Center, Samsung SDS}{Aug. 2022 -- Dec. 2024}
    ...
    % \item Introduced novel approaches to vulnerability discovery and systematically structured analysis methodologies for the team.
    % \item Expanded the traditional Red Team perspective to address AI safety issues and implemented an automated AI safety checker leveraging safety guardrail frameworks.
